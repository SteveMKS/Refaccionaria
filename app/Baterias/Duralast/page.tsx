...
type Subcategoria1 = {
  ...
  descripcion?: string;
  imagen_url?: string;
  id_categoria_main: CategoriaMain; // Relación con nombre corregido
};
...
type Subcategoria2 = {
  ...
  descripcion?: string;
  imagen_url?: string;
  id_subcategoria1: Subcategoria1; // Relación con nombre corregido
};
...
type Producto = {
  ...
  existencias: number;
  id_marca: Marca;
  id_subcategoria2: Subcategoria2; // Nombre corregido para coincidir con la consulta
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500 mb-4">
                    {producto.id.subcategoria2.id_subcategoria1.id_categoria_main.nombre}{' > '}
